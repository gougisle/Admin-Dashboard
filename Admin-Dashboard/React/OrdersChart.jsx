...
const _logger = debug.extend("Admin-OrderChart");
...
export default function OrderChart() {
  ...
  const chartOptions = {
    ...
    grid: {
      strokeDashArray: "5",
      borderColor: "rgba(125, 138, 156, 0.5)",
    },
    xaxis: {
      crosshairs: {
        width: 2,
  ...
  return (
    <>
      <Card className="card-box mb-5 px-4 pt-4 text-center shadow-info-sm">
        ...
        <div className="mb-4 buttons">{buttons}</div>
      </Card>
    </>
  );
}
